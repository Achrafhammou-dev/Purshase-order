...
<div class="card card-outline card-info">
    ...
    <select name="supplier_id" id="supplier_id" class="custom-select custom-select-sm rounded-0 select2" disabled>
					...
					<table class="table table-striped table-bordered" id="item-list">
						...
						<tbody>
							...
							<tr class="po-item" data-id="">
								...
								<input type="text" class="text-center w-100 border-0" name="qty[]" value="<?php echo $row['quantity'] ?>" readonly/></td>
<td class="align-middle p-1">
    <input type="text" class="text-center w-100 border-0" name="unit[]" value="<?php echo $row['unit'] ?>" readonly/>
</td>
<td class="align-middle p-1">
    <input type="hidden" name="item_id[]" value="<?php echo $row['item_id'] ?>">
    <input type="text" class="text-center w-100 border-0 item_id" value="<?php echo $row['name'] ?>" readonly/>
</td>
...
<span><?php echo number_format($row['quantity'] * $row['unit_price']) ?></span>
</td>
    ...
    <tr>
        <th class="p-1 text-right" colspan="6">
            <!-- <span>
                <button class="btn btn-sm btn-flat btn-primary py-0 mx-1" type="button" id="add_row">Add Row</button>
            </span>  -->
            Sub Total
        </th>
        <th class="p-1 text-right" id="sub_total">
            <span><?php echo isset($sub_total) ? number_format($sub_total, 2) : '0.00'; ?></span>
        </th>
    </tr>
    <tr>
        <th class="p-1 text-right" colspan="6">
            Discount (%)
            <input type="number" step="any" name="discount_percentage" class="border-light text-right" value="<?php echo isset($discount_percentage) ? $discount_percentage : 0 ?>" readonly/>
        </th>
        <th class="p-1">
            <input type="text" class="w-100 border-0 text-right" value="<?php echo isset($discount_amount) ? $discount_amount : 0 ?>" name="discount_amount" readonly/>
        </th>
    </tr>
    <tr>
        <th class="p-1 text-right" colspan="6">
            Tax Inclusive (%)
            <input type="number" step="any" name="tax_percentage" class="border-light text-right" value="<?php echo isset($tax_percentage) ? $tax_percentage : 0 ?>" readonly/>
        </th>
        <th class="p-1">
            <input type="text" class="w-100 border-0 text-right" value="<?php echo isset($tax_amount) ? $tax_amount : 0 ?>" name="tax_amount" readonly/>
        </th>
    </tr>
    <tr>
            ...
            <span><?php echo isset($total) ? number_format($total, 2) : '0.00'; ?></span>
					...
					<div class="row">
						<div class="col-md-6">
							...
							<textarea name="notes" id="notes" cols="10" rows="4" class="form-control rounded-0" readonly><?php echo isset($notes) ? $notes : '' ?></textarea>
						</div>
