					...
					<colgroup>
						...
						<tbody>
							...
							<tr class="pr-item" data-id="">
								...
								<td class="align-middle p-1">
									<input type="text" class="text-center w-100 border-0" name="Description_Item[]" value="<?php echo $row['Description_Item'] ?>"readonly/>
								</td>
								<td class="align-middle p-1">
						...
						<tfoot>
							<tr class="bg-lightblue">
								<tr>
									...
									<th class="p-1 text-right" id="sub_total"  colspan="8">0</th>
								</tr>
								<tr>
